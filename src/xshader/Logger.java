...
public final class Logger {
	...
	private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger("XShader");
	...
	/**
	 * inits the logger
	 * @param file the XShader .log file
	 */
	public static void init(File file) {
		...
		logger.info("XShader logger initialized.");
