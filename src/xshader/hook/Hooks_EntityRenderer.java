...
public class Hooks_EntityRenderer {
	...
	public static void hook_RenderWorld_Post(EntityRenderer entityRenderer, float f, long l){
		FBO.unBind();
		Utils.mc().getFramebuffer().bindFramebuffer(true);
		Shader.unBind();
		//GL11.glPushMatrix();
		...
		tessellator.addVertexWithUV(1, -1, 0, width/2048.0f, 0);
		tessellator.addVertexWithUV(1, 1, 0, width/2048.0f, height/2048.0f);
		tessellator.addVertexWithUV(-1, 1, 0, 0, height/2048.0f);
		tessellator.draw();
		Shader.unBind();
		//GL11.glMatrixMode(GL11.GL_PROJECTION);
		//GL11.glPopMatrix();
